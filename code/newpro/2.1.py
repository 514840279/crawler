...
def read_detial(url):
    ...
    colum=[
        ('title','//div[@class="clearfix w1000_320 text_title"]//h1//text()','l'),
        ('pushDate', '//div[@class="box01"]//div[@class="fl"]//text()', 'arr',0),
        ('content','//div[@class="box_con"]//text()','sarra',',')
   ]
    ...
    csv = Csv_base()
    csv.write_csv_file_line(file_path=path + "/data.csv", str=['中国军网', url, result[0][1], result[1][1], result[2][1]])
...
def main():
    ...
    for i in range(1,8):
        ...
        #print(list_html)
        colum=[('a','//div[@class="ej_list_box clear"]//ul//li//a//@href','sab','http://military.people.com.cn')]
