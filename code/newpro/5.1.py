...
def read_detial(url):
    ...
    colum=[
        ('title','//div[@class="tagpagetitle"]//h1//text()','l'),
        ('pushDate', '//div[@class="newsinfo_con"]//div//text()', 'arr',3),
        ('content','//div[@class="tagpagetext"]//div[@class="left tagtext"]//text()','sarra',',')
   ]
...
def main():
    ...
    for i in range(1,101):
        ...
        #print(list_html)
        colum=[('a','//div[@class="newslist_box"]//ul//li//div[@class="newslist_tit"]//a//@href','l')]
