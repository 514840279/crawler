...
def read_detial(url):
    ...
    colum=[
        ('title','//div[@class="content"]//div[@class="article-header"]//h1//text()','l'),
        ('pushDate', '//i[@class="time"]//text()', 'l'),
        ('content','//div[@class="content"]//div[@class="article-content p-t"]//text()','sarra',',')
   ]
...
def main():
    ...
    for i in range(1,6):
        ...
        #print(list_html)
        colum=[('a','//div[@class="content"]//ul//li//a//@href','sab','http://www.81.cn/rd/')]
